...
<template>
  <!-- Mounted once, when the seed is planted, and never unmounted across a
       phase change (NFR-A3). M4 fills it out; the frame is what matters
       here, because every later phase lands inside it rather than
       replacing it. -->
  <div class="workspace">
      ...
      <section class="panel">
        ...
        <ol class="stream">
          ...
          <li v-if="events.events.length === 0" class="empty">
            No activity yet. Shift+Enter starts the run.
          </li>
        </ol>
      </section>
    </main>
